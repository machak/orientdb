 ...
 * @since 8/17/2015
 */
public class OWALPageChangesCollector implements  OWALChanges {
  ...
  public int toStream(int offset, byte[] stream) {
    ...
    while (chunkIndex < pageChunks.length) {
      ...
      while (chunkIndex < pageChunks.length && (chunk == null && pageChunks[chunkIndex] == null || chunk != null && pageChunks[chunkIndex] != null)) {
        batchLen++;
        chunkIndex++;
      }
